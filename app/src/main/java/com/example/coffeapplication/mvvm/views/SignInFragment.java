        ...
        signInBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!mail.isEmpty() && !pass.isEmpty()) {
                    ...
                    Toast.makeText(getActivity().getApplicationContext(), "Field omitted", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
        ...
        auth.signInWithEmailAndPassword(email, pass).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()){
                    ...
                    startActivity(new Intent(getActivity(), AppActivity.class));
                    Toast.makeText(getActivity().getApplication(), "login SuccessFul", Toast.LENGTH_SHORT).show();
                } else {
