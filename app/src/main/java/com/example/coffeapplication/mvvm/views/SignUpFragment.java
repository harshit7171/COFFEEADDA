            ...
            public void onClick(View v) {
                ...
                if (!email.isEmpty() && !pass.isEmpty()){
                    if (!name.isEmpty() && !sec_name.isEmpty() && !birthday.isEmpty() && !gender.isEmpty()) {
                        ...
                        Toast.makeText(getActivity().getApplicationContext(), "Enter Details", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(getActivity().getApplicationContext(), "Recommended Field", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
